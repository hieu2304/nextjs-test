...
export const createSocial = async () => {
  try {
    await fetch(`https://1p8s3jhf8j.execute-api.us-east-1.amazonaws.com/Supermomos/interview/social`, {
      method: 'POST',
      headers: {
